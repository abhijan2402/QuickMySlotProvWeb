...
export default function ManageServicesPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-8">
      <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between items-center gap-4">
      ...
      <h3 className="font-semibold text-lg mb-1 px-2 text-gray-600">
        ...
        {services.map((service) => (
          <div className="mb-8 border p-4 rounded-md ">
            ...
            <div className="flex justify-start ">
              <div
                className={`rounded-md font-medium text-white text-base px-8 py-1 mb-4`}
                style={{
                  background:
            ...
            <div className="flex justify-between items-center mb-1">
              <div className="font-medium text-lg text-black">{service.name}</div>
